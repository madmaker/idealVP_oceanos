...
public class ReportLineOccurencesComparator implements Comparator<ReportLineOccurence>
{
	public int compare(ReportLineOccurence line0, ReportLineOccurence line1)
	{
		String field0 = line0.reportLine.id;
		String field1 = line1.reportLine.id;
