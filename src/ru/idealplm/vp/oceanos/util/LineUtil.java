...
{
	public static Font font = new Font("GOST type A Italic", Font.PLAIN, 14);
	public static String[] emptyValues = {};
	public static String[] nonbreakableWords = VPSettings.nonbreakableWords;
	public static String[] nonbreakablePlaneArray;
	...
	static public ArrayList<String> getFittedLines(String input, double maxWidth){
		...
		while(true){
			...
			if(fittedLine.equals(input)) break;
